...
myFMU = loadFMU("GridCabinAcceleration_12V.fmu")
...
function test()
    FMISensitivity.invalidate!(c.∂ẋ_∂x)
...
using FMISensitivity.FMIBase: getContinuousStates
...
myFMU = loadFMU("OpenSCALINGFuelCellStackModels_TestPEMFuelCellStackAndTILH2_0ParameterStudyWithOCs.fmu")
myFMU.executionConfig.use_sparsity_information = true
